...
var (
	log = myglog.New(os.Stderr)
)

func init() {
	// log.SetFlags(myglog.LglogFlags)
}
...
func GetLogLevel() myglog.Level {
	return log.Level()
}

func SendDingMsg(token string, secret string, title string, msg string) {
